  ...
  return (
    ...
    <Grid container   alignItems="center"  sx={{maxWidth:900, minWidth:350}}>
        ...
        >
            ...
            <Grid item>
                <NavLink to={`/miGrado/${grado}/estudiantes`}
            ...
            <Grid item>
                <NavLink 
                    to={`/miGrado/${grado}/notificacionesGrado`}
                    className={({ isActive }) =>
                        isActive ? "active":''
                    }
                >
                    <Tooltip title="Notificaciones">
                        ...
                        <IconButton color='secondary'>
                            <Badge
                                badgeContent={store.grados[grado].notificaciones.filter(item=>item.visto===false).length} 
                                anchorOrigin={{
                                    vertical: 'top',
                                    horizontal: 'right',
                                }}
